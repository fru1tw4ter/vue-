<template>
  <div class="ratingselect">
    <div class="rating-type">
      ...
      <span class="block negative" @click="select(1, $event)" :class="{'active': selectedType === 1}">{{desc.negative}}<span class="count">{{negatives.length}}</span></span>
    </div>
